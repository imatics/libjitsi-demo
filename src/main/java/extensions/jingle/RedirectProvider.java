    ...
    extends ExtensionElementProvider<RedirectPacketExtension>
{
     ...
     */
    @Override
    public RedirectPacketExtension parse(XmlPullParser parser, int i, XmlEnvironment xmlEnvironment) throws XmlPullParserException, IOException, SmackParsingException {
        String text = null;
        boolean done = false;
